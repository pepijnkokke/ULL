...
\item $p_\# = \{0.2, 0.5, 0.8\}$
\end{itemize}
Afterwards, we computed precision, recall and f zero for the words found, the lexical types found and the placement of word boundaries. $\rho$ is kept at a constant 2.
